...
import com.lyannyi.lr11.ui.firestoreTaskDialogs.EditFirestoreTaskDialog
import java.text.SimpleDateFormat
import java.util.Locale

@Composable
fun FirestoreTaskItem(
    task: FirestoreTask,
    onDeleteClick: (FirestoreTask) -> Unit,
    onEditClick: (FirestoreTask) -> Unit)
{
